...
public class InventoryService {
    ...
    public List<InventoryResponse> isInStock(List<String> skuCode){
        return inventoryRepository.findBySkuCodeIn(skuCode)   //to find all inventroy with this skewCode
                .stream()
                .map(inventory ->  //to map list of inventory obj which are coming as response
